        ...
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            temp.MELCOW['welcome'] = await message.reply(f"<b>𝓗𝓪𝓲👋 , {u.mention}, 𝚃𝙷𝙰𝙽𝙺𝚂 𝙵𝙾𝚁 𝙹𝙾𝙸𝙽𝙸𝙽𝙶💐 {message.chat.title} 𝚆𝙴 𝚆𝙾𝚄𝙻𝙳 𝙻𝙸𝙺𝙴 𝚃𝙾 ✮𝚆𝙴𝙻𝙲𝙾𝙼𝙴✮ 𝚈𝙾𝚄 𝚃𝙾 𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 😍 𝙰𝙽𝙳 𝙴𝚇𝚃𝚁𝙴𝙼𝙴𝙻𝚈 𝙷𝙰𝙿𝙿𝚈 𝚃𝙾 𝙷𝙰𝚅𝙴 𝚈𝙾𝚄 𝙰𝚂 𝙾𝙽𝙴 𝙾𝙵 𝚄𝚂🌷. </b>")
