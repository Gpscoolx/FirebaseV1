        ...
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            temp.MELCOW['welcome'] = await message.reply(f"<b>Hai👋 , {u.mention}, Thanks for joining💐 {message.chat.title} We would like to welcome you to our team😍 and extremely happy to have you as one of us🌷. </b>")
